...
$env:API_KEY           = '7af2221c27241dd524273d2752772aa43e6b18c0187dffbf'   # QH 共享 key(Phase F 切源)
...
$env:SYNC_WAIT_SEC     = "0.82"   # final result within budget, otherwise durable HTTP 202
