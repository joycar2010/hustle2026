param(
    [string]$Stage = "D:\QHMT5\deploy\mt5-execution-probe-memory-20260819.6-deploy",
...
$Release = "mt5-execution-probe-memory-20260819.6"
...
function Copy-DurableDatabase([string]$SourceDb, [string]$TargetDb, [string]$BackupPrefix) {
    ...
    try {
        foreach ($entry in $entries) {
            ...
            if (-not $samePath -and -not $reuseTarget[$suffix]) {
