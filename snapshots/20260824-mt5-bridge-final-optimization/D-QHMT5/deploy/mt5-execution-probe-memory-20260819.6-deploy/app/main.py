...
def _execute_close_batch(payload):
    ...
    if positions_override is _SNAPSHOT_UNSET:
        ...
        # close-all supplies its already-admitted snapshot here.  This keeps
        # both public endpoints on one canonical executor without a nested
        # positions_get call.
...
def _execute_close_all(payload):
    ...
    manifest = [{"ticket": ticket} for ticket in fixed_tickets]
