param(
    [string]$Stage = 'D:\QHMT5\runtime\staged\hedge-pro-mt5-v3-20260731'
)

$ErrorActionPreference = 'Stop'
$python = 'D:\QHMT5\runtime\releases\v1\venv-ic\Scripts\python.exe'
$liveApp = 'D:\QHMT5\runtime\releases\v1\ic\app'
$expectedMain = 'F8BAE4B044933B451E6F9BBE12837AC7A99584B5758A5EE8D2CF6499952E4462'
$expectedRuntime = '21A49D043450E3EA56FFA2E9B57487E2B6F88BA609005DCB49C7F8BC2EEE07BA'
