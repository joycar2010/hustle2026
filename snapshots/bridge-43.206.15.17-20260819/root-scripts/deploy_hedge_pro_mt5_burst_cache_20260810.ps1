param(
    [string]$Stage = 'D:\QHMT5\runtime\staged\hedge-pro-mt5-burst-cache-20260810'
)

$ErrorActionPreference = 'Stop'
$python = 'D:\QHMT5\runtime\releases\v1\venv-ic\Scripts\python.exe'
$liveApp = 'D:\QHMT5\runtime\releases\v1\ic\app'
$expectedMain = '1B411CA9AA72F3EACCAED0F6A873125584E3A1FE55EA8C8B87F5997C721C61B0'
...
$backup = "D:\QHMT5\backups\hedge-pro-mt5-burst-cache-$stamp"
