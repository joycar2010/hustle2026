...
const routes = [
  { path:'/', component:Layout, redirect:'/dashboard', children:[
    ...
    { path:'bi', name:'bi', meta:{title:'经营分析',icon:'TrendCharts',group:'分析'}, component:()=>import('../views/Bi.vue') },
    ...
    { path:'system', name:'system', meta:{title:'系统管理',icon:'Monitor',group:'运维'}, component:()=>import('../views/System.vue') },
    { path:'notify', name:'notify', meta:{title:'系统通知',icon:'Bell',group:'运维'}, component:()=>import('../views/Notify.vue') },
    { path:'datamgr', name:'datamgr', meta:{title:'数据管理',icon:'Coin',group:'运维'}, component:()=>import('../views/DataMgr.vue') },
