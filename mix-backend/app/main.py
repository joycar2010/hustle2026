...
from .routers import aicoin, positions, strategies, rules, accounts, misc, me, auth, history, ops, notify_center, credentials, ai, investor, risk
...
for r in (positions.router, strategies.router, rules.router, accounts.router, misc.router, me.router,
          ...
          investor.router, risk.router, aicoin.router):
