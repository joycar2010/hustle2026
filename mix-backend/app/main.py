...
from .routers import v6ops, portal, lab, webauthn_auth, training, research, fastlane, automation
...
API6 = "/api/v6"
for r in (v6ops.router, portal.router, lab.router, training.router, research.router, intents.router, fastlane.router, automation.router):
