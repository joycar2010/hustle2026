-- 为 notification_templates 表添加前端弹窗配置字段
-- 用于统一管理前端弹窗的标题、内容和声音设置

ALTER TABLE notification_templates
ADD COLUMN IF NOT EXISTS popup_title_template TEXT,
ADD COLUMN IF NOT EXISTS popup_content_template TEXT,
ADD COLUMN IF NOT EXISTS alert_sound_file VARCHAR(255),
ADD COLUMN IF NOT EXISTS alert_sound_repeat INTEGER DEFAULT 3;
