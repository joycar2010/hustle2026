...
class Config:
    ...
    min_t_remaining_sec: float = 60.0
    ...
    strong_delta_entry_window_sec: float = 180.0
    strong_delta_entry_min_t_remaining_sec: float = 120.0
    strong_delta_entry_min_price: float = 0.70
    strong_delta_entry_max_price: float = 1.0
    strong_delta_entry_up_min_delta_usd: float = 68.0
    strong_delta_entry_down_max_delta_usd: float = -68.0
    strong_delta_entry_confirm_checks: int = 3
    strong_delta_entry_risk_fraction: float = 0.03
    early_strong_delta_entry_enabled: bool = False
    early_strong_delta_entry_window_sec: float = 280.0
    early_strong_delta_entry_min_t_remaining_sec: float = 180.0
    early_strong_delta_entry_min_price: float = 0.50
    early_strong_delta_entry_max_price: float = 1.0
    early_strong_delta_entry_up_min_delta_usd: float = 100.0
    early_strong_delta_entry_down_max_delta_usd: float = -100.0
    early_strong_delta_entry_confirm_checks: int = 2
    early_strong_delta_entry_risk_fraction: float = 0.02
    early_strong_delta_entry_hedge_enabled: bool = False
    early_strong_delta_entry_hedge_max_price: float = 0.70
    late_edge_entry_enabled: bool = True
    late_edge_entry_window_sec: float = 60.0
    late_edge_entry_min_t_remaining_sec: float = 10.0
    late_edge_entry_min_price: float = 0.75
    late_edge_entry_max_price: float = 0.95
    late_edge_entry_delta_filter_enabled: bool = False
    late_edge_entry_up_min_delta_usd: float = 10.0
    late_edge_entry_down_max_delta_usd: float = -10.0
    ...
    entry_momentum_filter_enabled: bool = True
    ...
    normal_scale_in_enabled: bool = True
    max_buys_per_market: int = 1
    one_side_per_market: bool = True
    trend_overheat_filter_enabled: bool = True
    trend_overheat_min_streak: int = 3
    trend_overheat_price_floor: float = 0.90
    confirm_checks: int = 4
    order_risk_fraction: float = 0.04
    ...
    sell_exit_max_depth_ticks: int = 0
...
def load() -> Config:
    ...
    return Config(
        ...
        min_net_edge=_float("MIN_NET_EDGE", 0.04),
        high_price_edge_threshold=_float("HIGH_PRICE_EDGE_THRESHOLD", 0.0),
        high_price_min_net_edge=_float("HIGH_PRICE_MIN_NET_EDGE", 0.04),
        ...
        btc_delta_threshold_usd=_float("BTC_DELTA_THRESHOLD_USD", 8.0),
        btc_up_min_delta_usd=_float("BTC_UP_MIN_DELTA_USD", 15.0),
        btc_up_max_delta_usd=_float("BTC_UP_MAX_DELTA_USD", 0.0),
        btc_down_min_delta_usd=_float("BTC_DOWN_MIN_DELTA_USD", 0.0),
        btc_down_max_delta_usd=_float("BTC_DOWN_MAX_DELTA_USD", -15.0),
        ...
        eth_trading_enabled=_bool("ETH_TRADING_ENABLED", False),
        ...
        seconds_before_close=_int("SECONDS_BEFORE_CLOSE", 120),
        min_t_remaining_sec=_float("MIN_T_REMAINING_SEC", 60.0),
        ...
        strong_delta_entry_window_sec=_float("STRONG_DELTA_ENTRY_WINDOW_SEC", 180.0),
        strong_delta_entry_min_t_remaining_sec=_float("STRONG_DELTA_ENTRY_MIN_T_REMAINING_SEC", 120.0),
        strong_delta_entry_min_price=_float("STRONG_DELTA_ENTRY_MIN_PRICE", 0.70),
        strong_delta_entry_max_price=_float("STRONG_DELTA_ENTRY_MAX_PRICE", 1.0),
        strong_delta_entry_up_min_delta_usd=_float("STRONG_DELTA_ENTRY_UP_MIN_DELTA_USD", 68.0),
        strong_delta_entry_down_max_delta_usd=_float("STRONG_DELTA_ENTRY_DOWN_MAX_DELTA_USD", -68.0),
        strong_delta_entry_confirm_checks=_int("STRONG_DELTA_ENTRY_CONFIRM_CHECKS", 3),
        strong_delta_entry_risk_fraction=_float("STRONG_DELTA_ENTRY_RISK_FRACTION", 0.03),
        ...
        early_strong_delta_entry_min_t_remaining_sec=_float("EARLY_STRONG_DELTA_ENTRY_MIN_T_REMAINING_SEC", 180.0),
        early_strong_delta_entry_min_price=_float("EARLY_STRONG_DELTA_ENTRY_MIN_PRICE", 0.50),
        early_strong_delta_entry_max_price=_float("EARLY_STRONG_DELTA_ENTRY_MAX_PRICE", 1.0),
        early_strong_delta_entry_up_min_delta_usd=_float("EARLY_STRONG_DELTA_ENTRY_UP_MIN_DELTA_USD", 100.0),
        early_strong_delta_entry_down_max_delta_usd=_float("EARLY_STRONG_DELTA_ENTRY_DOWN_MAX_DELTA_USD", -100.0),
        early_strong_delta_entry_confirm_checks=_int("EARLY_STRONG_DELTA_ENTRY_CONFIRM_CHECKS", 2),
        early_strong_delta_entry_risk_fraction=_float("EARLY_STRONG_DELTA_ENTRY_RISK_FRACTION", 0.02),
        ...
        late_edge_entry_enabled=_bool("LATE_EDGE_ENTRY_ENABLED", True),
        ...
        late_edge_entry_min_price=_float("LATE_EDGE_ENTRY_MIN_PRICE", 0.75),
        late_edge_entry_max_price=_float("LATE_EDGE_ENTRY_MAX_PRICE", 0.95),
        late_edge_entry_delta_filter_enabled=_bool("LATE_EDGE_ENTRY_DELTA_FILTER_ENABLED", False),
        late_edge_entry_up_min_delta_usd=_float("LATE_EDGE_ENTRY_UP_MIN_DELTA_USD", 10.0),
        late_edge_entry_down_max_delta_usd=_float("LATE_EDGE_ENTRY_DOWN_MAX_DELTA_USD", -10.0),
        ...
        late_edge_entry_risk_fraction=_float("LATE_EDGE_ENTRY_RISK_FRACTION", 0.04),
        ...
        entry_momentum_filter_enabled=_bool("ENTRY_MOMENTUM_FILTER_ENABLED", True),
        entry_momentum_min_price=_float("ENTRY_MOMENTUM_MIN_PRICE", 0.80),
        entry_momentum_max_price=_float("ENTRY_MOMENTUM_MAX_PRICE", 0.93),
        entry_momentum_max_ask_move=_float("ENTRY_MOMENTUM_MAX_ASK_MOVE", 0.03),
        ...
        tail_entry_enabled=_bool("TAIL_ENTRY_ENABLED", True),
        ...
        tail_entry_min_price=_float("TAIL_ENTRY_MIN_PRICE", 0.60),
        tail_entry_max_price=_float("TAIL_ENTRY_MAX_PRICE", 1.0),
        tail_entry_confirm_checks=_int("TAIL_ENTRY_CONFIRM_CHECKS", 1),
        tail_entry_risk_fraction=_float("TAIL_ENTRY_RISK_FRACTION", 0.03),
        ...
        normal_scale_in_enabled=_bool("NORMAL_SCALE_IN_ENABLED", True),
        max_buys_per_market=_int("MAX_BUYS_PER_MARKET", 1),
        one_side_per_market=_bool("ONE_SIDE_PER_MARKET", True),
        trend_overheat_filter_enabled=_bool("TREND_OVERHEAT_FILTER_ENABLED", True),
        ...
        confirm_checks=_int("CONFIRM_CHECKS", 4),
        order_risk_fraction=_float("ORDER_RISK_FRACTION", 0.04),
        ...
        max_orders_per_hour=_int("MAX_ORDERS_PER_HOUR", 0),
        max_open_positions=_int("MAX_OPEN_POSITIONS", 10),
        max_daily_loss_fraction=_float("MAX_DAILY_LOSS_FRACTION", 0.15),
        max_daily_realized_profit_usd=_float("MAX_DAILY_REALIZED_PROFIT_USD", 0.0),
        consecutive_loss_kill=_int("CONSECUTIVE_LOSS_KILL", 3),
        order_retry_cooldown_sec=_float("ORDER_RETRY_COOLDOWN_SEC", 1.0),
        max_buy_retries_per_market=_int("MAX_BUY_RETRIES_PER_MARKET", 5),
        retry_min_t_remaining_sec=_float("RETRY_MIN_T_REMAINING_SEC", 20.0),
        max_retry_price_drift_ticks=_int("MAX_RETRY_PRICE_DRIFT_TICKS", 2),
        ...
        stagnation_window_sec=_float("STAGNATION_WINDOW_SEC", 30.0),
        volatility_window_sec=_float("VOLATILITY_WINDOW_SEC", 5.0),
        max_top_move_ticks=_int("MAX_TOP_MOVE_TICKS", 6),
        ...
        reversal_exit_window_sec=_float("REVERSAL_EXIT_WINDOW_SEC", 40.0),
        reversal_normal_min_t_remaining_sec=_float("REVERSAL_NORMAL_MIN_T_REMAINING_SEC", 10.0),
        ...
        reversal_confirm_checks=_int("REVERSAL_CONFIRM_CHECKS", 2),
        ...
        reversal_late_exit_enabled=_bool("REVERSAL_LATE_EXIT_ENABLED", True),
        ...
        sell_exit_max_depth_ticks=_int("SELL_EXIT_MAX_DEPTH_TICKS", 0),
        ...
        weather_live_trading_enabled=_bool("WEATHER_LIVE_TRADING_ENABLED", False),
