    ...
    <div class="flex-1 overflow-y-auto px-2 py-0.5 space-y-0.5">
      ...
      <div class="card p-1 lg:p-0.5">
        ...
        <div class="mb-1 lg:mb-0.5">
          ...
          <p class="text-[9px] lg:text-[8px] text-gray-500 mb-0.5">反开差/反平差 — 请在策略面板中按产品对设置</p>
        ...
        <div class="mb-1 lg:mb-0.5 border-t border-gray-700 pt-1 lg:pt-0.5">
          ...
          <p class="text-[9px] lg:text-[8px] text-gray-500 mb-0.5">正开差/正平差 — 请在策略面板中按产品对设置</p>
          <div class="grid grid-cols-2 gap-1 lg:gap-0.5">
            <div>
...
const alertSettings = ref({
  ...
  // MT5 Lag Count
  mt5LagCount: 5,
  // Reverse Arbitrage sync counts (差值阈值已迁移至策略面板按产品对独立设置)
