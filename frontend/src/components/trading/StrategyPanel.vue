    ...
    <div class="flex-1 overflow-y-auto p-2 md:p-3 space-y-2 min-h-0">
      ...
      <div class="bg-[#252930] rounded p-2 md:p-3">
        <div class="flex flex-col gap-2 md:grid md:grid-cols-3 md:gap-3">
          ...
          <!-- Spread Display -->
          <div class="flex justify-between md:block md:text-center">
            <div class="text-xs text-gray-400 mb-0 md:mb-1 whitespace-nowrap">
              {{ type === 'reverse' ? '做多Bybit点差' : '做多Binance点差' }}
            </div>
            <div :class="['text-base md:text-xl font-mono font-bold whitespace-nowrap', type === 'reverse' ? 'text-[#0ecb81]' : 'text-[#f6465d]']">
