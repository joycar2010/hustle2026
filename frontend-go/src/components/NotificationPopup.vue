<template>
  <Transition :name="isMobile ? 'slide-down' : 'slide-right'">
    <div
      ...
      class="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90vw] max-w-sm bg-[#1e2329]/30 border border-[#2b3139]/20 rounded-lg shadow-2xl overflow-hidden"
    >
      <!-- Header -->
...
const shouldShowPopup = computed(() => {
  ...
  const criticalTypes = [
    ...
    'forward_open',          // 正向开仓点差提醒
    'forward_close',         // 正向平仓点差提醒
    'reverse_open',          // 反向开仓点差提醒
    'reverse_close',         // 反向平仓点差提醒
  ]
