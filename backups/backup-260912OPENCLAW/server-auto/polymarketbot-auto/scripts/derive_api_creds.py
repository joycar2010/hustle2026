...
# Keep credential derivation on the same SDK major/version used by the trading
# and setup-check paths.  The legacy ``py_clob_client`` package exposes a
# similarly named method but can produce credentials/signatures that the v2
# order client cannot use reliably.
