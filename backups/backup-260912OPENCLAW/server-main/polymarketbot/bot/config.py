...
def load() -> Config:
    ...
    # stale copied .env cannot silently re-enable a forbidden polyauto path.
    eth_live = _bool("ETH_TRADING_ENABLED", False) and not polyauto_instance
    ...
    return Config(
        ...
        eth_live_allowed=not polyauto_instance,
