import{f as r}from"./chartEditStore-57c78232.js";import{cs as m}from"./index-cd38ccec.js";const c={},u={echarts:m},d=n=>{if(!n.events)return{};const e={};for(const t in n.events.baseEvent){const o=n.events.baseEvent[t];o&&(e[t]=a(o))}const s=n.events.advancedEvents||{},E={[r.VNODE_BEFORE_MOUNT](t){c[n.id]=t.component;const o=(s[r.VNODE_BEFORE_MOUNT]||"").trim();i(o,t)},[r.VNODE_MOUNTED](t){const o=(s[r.VNODE_MOUNTED]||"").trim();i(o,t)}};return{...e,...E}};function a(n){try{return new Function(`
      return (
