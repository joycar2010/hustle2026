...
async function migrateData() {
  try {
    ...
    console.log('\n数据迁移统计:');
    console.log(`- 用户: ${mockData.users.length} 条`);
    console.log(`- 分类: ${mockData.categories.length} 条`);
    console.log(`- 作品: ${mockData.works.length} 条`);
    console.log(`- 线索: ${mockData.leads.length} 条`);
    console.log('- 系统设置: 1 条');
    console.log('- 关于我们: 1 条');
  } catch (error) {
